      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <div className="text-left">
              <p className="text-white font-mono font-black text-2xl tracking-widest uppercase">Inspect</p>
              <p className="text-zinc-500 font-mono text-xs tracking-[0.3em] uppercase">Sistema de Inspección</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-mono font-semibold uppercase tracking-widest text-zinc-400 mb-1">
                Correo electrónico
              </label>
              <input
                type="email"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-amber-500 text-zinc-900 font-mono font-black text-sm uppercase tracking-widest py-3 hover:bg-amber-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-2"
            >
